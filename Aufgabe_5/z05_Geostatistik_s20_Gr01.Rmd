...
Die Streeung der Varianzen ist über die verschiedenen Distanzen relativ gleichmäßig verteilt. Entweder ist die Ähnlichkeit zweier Werte unabhängig von ihrer Lage, oder sie müssen sehr nahe bei einander seiliegen um ähnliche Werte anzunehmen.
...
var1 <- variogram(Ca_exch~1, 
                  ...
                  width= 150 #entspricht Abstand der Proben des Rastersamplings.Sehr nahe am Defaultwert cuttoff/15=2202/15=146.8
                    )
...
Sill (=140) und Nugget (=30) wurden geschätzt wodurch sich ein Partial Sill von 110 ergibt: psill= sill-nugget = 140-30 = 110

...
np: die Anzahl der Punktpaare für die Schätzung.
the number of point pairs for this estimate; in case of a variogramCloud see below. Im Fall von cloud=TRUE die (ID)Nummern des Punktepaares, das zu einer Variogrammwolkenschätzung beigetragen hat.

dist:
durchschnittliche Entfernung aller Punktepaare die in die Schätzing der KLasse eingegangen sind.

gamma: Wert der Stichprobenvariogramm-Schätzung

...
2.) Abschätzen von Sill und Nugget aus Variogramm-Graphik. Sill (=140) und Nugget (=30) wurden geschätzt wodurch sich ein Partial Sill von 110 ergibt: psill= sill-nugget = 140-30 = 110

3.) Wahl eines Models in vgm(). Das sphärische Modell ("Sph") erzielt den besten fit.

4.) Wahl von fit.method in fit.variogramm() um Modell weiter anzupassen.
...
v_fit <- fit.variogram(object = var1,
                  ...
                  #fit.sills = TRUE,
                  #fit.ranges = TRUE,
                  fit.method = 0,#vgl. Gstat user's manual, 
                                 #p. 42, tab. 4.2,

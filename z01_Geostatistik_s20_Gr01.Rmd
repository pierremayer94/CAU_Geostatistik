...
Hier koennen sie Aufgabe 1 beantworten. Bei Erlaeuterungen achten Sie natuerlich auf korrekte Zitation wie etwa [@akin1988]. 
...
- 2. spANOVA: Das Paket spANOVA ermöglicht eine Varianzanalyse von korrelierenden Rasterdatensaetzen.
...
Erforschen sie selbstaendig die Funktion read_delim des readr Paketes. Beschreiben sie kurz, was die Methode macht und auf welche Einstellungsmöglichkeiten (Argumente) besonders zu achten ist. (2 Punkte)
...
#Der Befehl savehistory(".Rhistory") laesst sich im R-Code ausfuehren, fuehrt aber zu Fehlermeldungen beim Knit. Dieser wird daher vor dem Knitvorgang auskommentiert. Das gleiche Problem liegt bei quit() vor. 
...
- Zufallsvariable (random variable):
   ...
   heißt Zufallsvariable" [Hedderich, Sachs 2008]. Sie ist nicht zufaellig oder variabel, sondern durch reelle Zahlen festgelegt.
...
- Regionalisierte Variable (regionalized variable):
  ...
  Eine Variable z(x̰), die Werte in Abhaengigkeit vom Ort x̰ in einem bestimmten Bereich (Region) angibt, 
...
- Stationaritaet (stationarity):
  ...
  ist eine Zufallsvariable stationaer. Die Variable waere dann "unabhaengig von der absoluten Lage und konstant im Beobachtungsraum" [Akin, Siemens 1988].
...
- Semivarianz (semivariance): 
  ...
  dass je größer die Entfernung ist, desto geringer ist ihre Aehnlichkeit. 

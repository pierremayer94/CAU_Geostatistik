...
$P(A|B)$
für die Fälle
1.) A und B sind unabhängig von einander: 
...
2.) A und B schließen einander aus
...
- Da nicht spezifiziert wird ob Mannschaft X oder Y drei Rote Karten erhält, lediglich eine Mannschaft alle, gibt es zwei mögliche Pfade, die die Bedingung erfüllen, wenn man sich ein enttsprechendes Baumdiagramm erstellt.

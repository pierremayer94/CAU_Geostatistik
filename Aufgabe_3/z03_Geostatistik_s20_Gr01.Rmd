...
boxplot.stats(ljz$Ca_exch) # u.a. Liste der Ausreißer
...
box_plot <- ggplot(ljz, aes(x=factor(ljz$SAMPLE), y=ljz$SAMPLECa_exch)) #x als sample der richitge weg?
